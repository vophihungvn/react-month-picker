      ...
      },
      {
        ...
        value: function optionPad(padIndex) {
          ...
          if (isRange) {
            ...
            labelPreText = /*#__PURE__*/ _react["default"].createElement(
              "b",
              null,
          ...
          if (autoRange === 0) {
            if (padIndex === 1 && otherValue.year === labelYear)
              prevCss = "disable";
            if (padIndex === 0 && otherValue.year === labelYear)
              nextCss = "disable";
          }

          var prevHandler =
            prevCss === "disable" ? undefined : this._goPrevYear;
          var nextHandler =
            nextCss === "disable" ? undefined : this._goNextYear;
          var valOffset = 0;
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              mapToArray(12, function (i) {
                ...
                if (atMinYear && m < ymArr[0].min) {
                  ...
                  for (
                    var _i = valOffset, last = values.length - 1;
                    _i <= last;
                    _i++
                  ) {
                    var v = values[_i];
                    ...
                    if (otherM) {
                      if (
                        (padIndex === 0 &&
                          nextCss === "disable" &&
                          m > otherM) ||
                        (padIndex === 1 && prevCss === "disable" && m < otherM)
                      ) {
                        css = "disable";
                      }
                    }
                ...
                var clickHandler =
                  css !== "disable" ? _this2._handleClickMonth : undefined;
                return /*#__PURE__*/ _react["default"].createElement(
                  "li",
                  {
                    key: i,
...
_defineProperty(MonthPicker, "propTypes", {
  ...
  years: _propTypes["default"].oneOfType([
    _propTypes["default"].number, // exact number of a year
  ...
  value: _propTypes["default"].oneOfType([
    TypeYM,
    _propTypes["default"].arrayOf(TypeYM),
    _propTypes["default"].shape({
      from: TypeYM,
      to: TypeYM,
    }),
  ]),
  lang: _propTypes["default"].oneOfType([
    _propTypes["default"].arrayOf(_propTypes["default"].string), // lang texts for months: ['Jan', 'Feb', 'Mar', 'Apr', ... ]
    _propTypes["default"].shape({
